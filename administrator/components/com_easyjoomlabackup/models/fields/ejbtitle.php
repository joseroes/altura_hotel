...
class JFormFieldEjbTitle extends JFormField
{
    protected $type = 'EjbTitle';
    ...
    {
        JHTML::stylesheet('administrator/components/com_easyjoomlabackup/css/easyjoomlabackup.css');
